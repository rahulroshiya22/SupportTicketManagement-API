    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Ticket>(e =>
            {
                ...
                e.Property(t => t.Description).IsRequired().HasColumnType("nvarchar(max)");
                ...
                // CreatedBy → RESTRICT (user deletion won't cascade)
                e.HasOne(t => t.CreatedBy)
                    .WithMany(u => u.CreatedTickets)
                    .HasForeignKey(t => t.CreatedById)
                    .OnDelete(DeleteBehavior.Restrict);

                // AssignedTo → RESTRICT, nullable
            ...
            {
                e.HasKey(c => c.Id);
                e.Property(c => c.Comment).IsRequired().HasColumnType("nvarchar(max)");

                // Ticket → CASCADE (delete ticket = delete comments)
                e.HasOne(c => c.Ticket)
